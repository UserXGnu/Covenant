...
namespace EasyPeasy.Controllers
{
    ...
    {
        private readonly EasyPeasy.Models.Listeners.HttpListenerContext _context;
        private readonly EasyPeasy.Models.Listeners.InternalListener _internalListener;

		public HttpListenerController(EasyPeasy.Models.Listeners.HttpListenerContext context, EasyPeasy.Models.Listeners.InternalListener internalListener)
        {
            _context = context;
