...
{
    public class EasyPeasyHubService : IRemoteEasyPeasyService
    {
        private HubConnection _connection;
        public EasyPeasyHubService(IConfiguration configuration)
        {
            ...
            _connection = new HubConnectionBuilder()
                .WithUrl("https://localhost:" + configuration["EasyPeasyPort"] + "/covenantHub", options =>
                {
        ...
        public Task<BridgeProfile> CreateBridgeProfile(BridgeProfile profile, EasyPeasyUser currentUser)
        {
        ...
        public Task<HttpProfile> CreateHttpProfile(HttpProfile profile, EasyPeasyUser currentUser)
        {
        ...
        public Task<Profile> CreateProfile(Profile profile, EasyPeasyUser currentUser)
        {
        ...
        public Task<EasyPeasyUser> CreateUser(EasyPeasyUserLogin login)
        {
            return _connection.InvokeAsync<EasyPeasyUser>("CreateUser", login);
        }
        ...
        public Task<EasyPeasyUser> CreateUserVerify(ClaimsPrincipal principal, EasyPeasyUserRegister register)
        {
            return _connection.InvokeAsync<EasyPeasyUser>("CreateUserVerify", principal, register);
        }
        ...
        public Task<BridgeProfile> EditBridgeProfile(BridgeProfile profile, EasyPeasyUser currentUser)
        {
        ...
        public Task<Grawl> EditGrawl(Grawl grawl, EasyPeasyUser user)
        {
        ...
        public Task<HttpProfile> EditHttpProfile(HttpProfile profile, EasyPeasyUser currentUser)
        {
        ...
        public Task<Profile> EditProfile(Profile profile, EasyPeasyUser currentUser)
        {
        ...
        public Task<EasyPeasyUser> EditUser(EasyPeasyUser currentUser)
        {
            return _connection.InvokeAsync<EasyPeasyUser>("EditUser", currentUser);
        }

        public Task<EasyPeasyUser> EditUserPassword(EasyPeasyUser currentUser, EasyPeasyUserLogin user)
        {
            return _connection.InvokeAsync<EasyPeasyUser>("EditUserPassword", currentUser, user);
        }
        ...
        public Task<EasyPeasyUser> GetCurrentUser(ClaimsPrincipal principal)
        {
            return _connection.InvokeAsync<EasyPeasyUser>("GetCurrentUser", principal);
        }
        ...
        public Task<EasyPeasyUser> GetUser(string userId)
        {
            return _connection.InvokeAsync<EasyPeasyUser>("GetUser", userId);
        }

        public Task<EasyPeasyUser> GetUserByUsername(string username)
        {
            return _connection.InvokeAsync<EasyPeasyUser>("GetUserByUsername", username);
        }
        ...
        public Task<IEnumerable<EasyPeasyUser>> GetUsers()
        {
            return _connection.InvokeAsync<IEnumerable<EasyPeasyUser>>("GetUsers");
        }
        ...
        public Task<EasyPeasyUserLoginResult> Login(EasyPeasyUserLogin login)
        {
            return _connection.InvokeAsync<EasyPeasyUserLoginResult>("Login", login);
        }
