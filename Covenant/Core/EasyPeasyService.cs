...
using Encrypt = EasyPeasy.Core.Encryption;
...
{
    public interface IEasyPeasyUserService
    {
        Task<IEnumerable<EasyPeasyUser>> GetUsers();
        Task<EasyPeasyUser> GetUser(string userId);
        Task<EasyPeasyUser> GetUserByUsername(string username);
        Task<EasyPeasyUser> GetCurrentUser(ClaimsPrincipal principal);
        Task<EasyPeasyUserLoginResult> Login(EasyPeasyUserLogin login);
        Task<EasyPeasyUser> CreateUserVerify(ClaimsPrincipal principal, EasyPeasyUserRegister register);
        Task<EasyPeasyUser> CreateUser(EasyPeasyUserLogin login);
        Task<EasyPeasyUser> EditUser(EasyPeasyUser currentUser);
        Task<EasyPeasyUser> EditUserPassword(EasyPeasyUser currentUser, EasyPeasyUserLogin user);
    ...
    public interface IGrawlService
    {
        ...
        Task<Grawl> EditGrawl(Grawl grawl, EasyPeasyUser user);
    ...
    public interface IProfileService
    {
        ...
        Task<Profile> CreateProfile(Profile profile, EasyPeasyUser currentUser);
        Task<Profile> EditProfile(Profile profile, EasyPeasyUser currentUser);
        ...
        Task<HttpProfile> CreateHttpProfile(HttpProfile profile, EasyPeasyUser currentUser);
        Task<BridgeProfile> CreateBridgeProfile(BridgeProfile profile, EasyPeasyUser currentUser);
        Task<IEnumerable<Profile>> CreateProfiles(params Profile[] profiles);
        Task<HttpProfile> EditHttpProfile(HttpProfile profile, EasyPeasyUser currentUser);
        Task<BridgeProfile> EditBridgeProfile(BridgeProfile profile, EasyPeasyUser currentUser);
    }
    ...
    public interface IEasyPeasyService : IEasyPeasyUserService, IIdentityRoleService, IIdentityUserRoleService, IThemeService,
    ...
    public interface IRemoteEasyPeasyService : IEasyPeasyUserService, IIdentityRoleService, IIdentityUserRoleService, IThemeService,
        IEventService, IImplantTemplateService, IGrawlService, IGrawlTaskService,
        IGrawlCommandService, ICommandOutputService, IGrawlTaskingService,
        ICredentialService, IIndicatorService, IListenerService, IProfileService, IHostedFileService, ILauncherService
    {
    ...
    public class EasyPeasyService : IEasyPeasyService
    {
        protected readonly DbContextOptions<EasyPeasyContext> _options;
        protected EasyPeasyContext _context;
        protected readonly INotificationService _notifier;
        protected readonly UserManager<EasyPeasyUser> _userManager;
        protected readonly SignInManager<EasyPeasyUser> _signInManager;
        protected readonly IConfiguration _configuration;
        protected readonly ConcurrentDictionary<int, CancellationTokenSource> _cancellationTokens;

        public EasyPeasyService(DbContextOptions<EasyPeasyContext> options, EasyPeasyContext context, INotificationService notifier,
            UserManager<EasyPeasyUser> userManager, SignInManager<EasyPeasyUser> signInManager,
        ...
        {
            _context.Dispose();
            _context = new EasyPeasyContext(_options);
        }
        ...
        #region EasyPeasyUser Actions
        public async Task<IEnumerable<EasyPeasyUser>> GetUsers()
        {
        ...
        public async Task<EasyPeasyUser> GetUser(string userId)
        {
            EasyPeasyUser user = await _context.Users
                .Include(U => U.Theme)
                .FirstOrDefaultAsync(U => U.Id == userId);
            if (user == null)
            {
                throw new ControllerNotFoundException($"NotFound - EasyPeasyUser with id: {userId}");
            }
            return user;
        }

        public async Task<EasyPeasyUser> GetUserByUsername(string username)
        {
            EasyPeasyUser user = await _context.Users
                .Include(U => U.Theme)
            ...
            if (user == null)
            {
                throw new ControllerNotFoundException($"NotFound - EasyPeasyUser with Username: {username}");
            }
            return user;
        }

        public async Task<EasyPeasyUser> GetCurrentUser(ClaimsPrincipal principal)
        {
            EasyPeasyUser user = await _userManager.GetUserAsync(principal);
            if (user == null)
            {
        ...
        public async Task<EasyPeasyUserLoginResult> Login(EasyPeasyUserLogin login)
        {
            SignInResult result = await _signInManager.PasswordSignInAsync(login.UserName, login.Password, false, false);
            if (!result.Succeeded)
            {
                return new EasyPeasyUserLoginResult { Success = false, EasyPeasyToken = "" };
            }
            EasyPeasyUser user = await _context.Users
                .Include(U => U.Theme)
            ...
            return new EasyPeasyUserLoginResult { Success = true, EasyPeasyToken = token };
        }

        public async Task<EasyPeasyUser> CreateUserVerify(ClaimsPrincipal principal, EasyPeasyUserRegister register)
        {
            ...
            EasyPeasyUser created = await CreateUser(new EasyPeasyUserLogin { UserName = register.UserName, Password = register.Password });
            ...
            // _notifier.OnCreateEasyPeasyUser?.Invoke(this, created);
            return created;
        }

        public async Task<EasyPeasyUser> CreateUser(EasyPeasyUserLogin login)
        {
            EasyPeasyUser user = new EasyPeasyUser { UserName = login.UserName };
            ...
            if (!userResult.Succeeded)
            {
                ...
                string ErrorMessage = $"BadRequest - Could not create EasyPeasyUser: {user.UserName}";
            ...
            EasyPeasyUser savedUser = await _userManager.Users.FirstOrDefaultAsync(U => U.UserName == user.UserName);
            if (savedUser == null)
            {
                throw new ControllerNotFoundException($"NotFound - Could not find EasyPeasyUser with username: {user.UserName}");
            }
            ...
            // _notifier.OnCreateEasyPeasyUser(this, savedUser);
            await _notifier.NotifyCreateEvent(this, userEvent);
            return savedUser;
        }

        public async Task<EasyPeasyUser> EditUser(EasyPeasyUser user)
        {
            EasyPeasyUser matching_user = await _userManager.Users.FirstOrDefaultAsync(U => U.Id == user.Id);
            if (matching_user == null)
            {
                throw new ControllerNotFoundException($"NotFound - EasyPeasyUser with id: {user.Id}");
            }
            matching_user.ThemeId = user.ThemeId;
            IdentityResult result = await _userManager.UpdateAsync(matching_user);
            if (!result.Succeeded)
            {
                throw new ControllerBadRequestException($"BadRequest - Could not edit EasyPeasyUser with id: {user.Id}");
            }
            // await _context.SaveChangesAsync();
            await _notifier.NotifyEditEasyPeasyUser(this, matching_user);
            return matching_user;
        }

        public async Task<EasyPeasyUser> EditUserPassword(EasyPeasyUser currentUser, EasyPeasyUserLogin user)
        {
            EasyPeasyUser matching_user = await _userManager.Users.FirstOrDefaultAsync(U => U.UserName == user.UserName);
            if (matching_user == null)
            {
                throw new ControllerNotFoundException($"NotFound - EasyPeasyUser with username: {user.UserName}");
            }
            ...
            if (!result.Succeeded)
            {
                throw new ControllerBadRequestException($"BadRequest - Could not set new password for EasyPeasyUser with username: {user.UserName}");
            }
            // await _context.SaveChangesAsync();
            await _notifier.NotifyEditEasyPeasyUser(this, matching_user);
            return matching_user;
        ...
        {
            EasyPeasyUser user = await this.GetUser(userId);
            if (await this.IsAdmin(user) && this.GetAdminCount() == 1)
            {
                string ErrorMessage = $"BadRequest - Could not delete EasyPeasyUser with id: {userId}";
                ErrorMessage += "Can't delete the last Administrative user.";
                throw new ControllerBadRequestException(ErrorMessage);
            }
            _context.Users.Remove(user);
            await _context.SaveChangesAsync();
            await _notifier.NotifyDeleteEasyPeasyUser(this, user.Id);
        }

        private IQueryable<EasyPeasyUser> GetAdminUsers()
        {
        ...
        private async Task<bool> IsAdmin(EasyPeasyUser user)
        {
        ...
        {
            EasyPeasyUser user = await _userManager.Users.FirstOrDefaultAsync(U => U.Id == userId);
            if (user == null)
            {
                throw new ControllerNotFoundException($"NotFound - EasyPeasyUser with id: {userId}");
            }
            ...
            if (!result.Succeeded)
            {
                string Errors = $"BadRequest - Could not add EasyPeasyUser: {user.UserName} to role: {role.Name}";
        ...
        public async Task DeleteUserRole(string userId, string roleId)
        {
            ...
            {
                string ErrorMessage = $"BadRequest - Could not remove EasyPeasyUser with id: {userId} from Administrative role";
            ...
            {
                throw new ControllerBadRequestException($"BadRequest - Could not remove role: {role.Name} from EasyPeasyUser: {user.UserName}");
            }
            await _context.SaveChangesAsync();
        ...
        public async Task<string> GetDownloadContent(int eventId)
        {
            ...
            string filename = Path.Combine(Common.EasyPeasyDownloadDirectory, theEvent.FileName);
        ...
        public async Task<string> GetScreenshotContent(int eventId)
        {
            ...
            string filename = System.IO.Path.Combine(Common.EasyPeasyDownloadDirectory, Utilities.GetSanitizedFilename(theEvent.FileName));
        ...
        public async Task<Grawl> EditGrawl(Grawl grawl, EasyPeasyUser user = null)
        {
        ...
        private byte[] CompileGrawlCode(string CodeTemplate, ImplantTemplate template, Grawl grawl, Listener listener, Profile profile, OutputKind outputKind = OutputKind.DynamicallyLinkedLibrary, bool Compress = false, Compiler.RuntimeIdentifier runtimeIdentifier = Compiler.RuntimeIdentifier.win_x64)
        {
            ...
            else if (grawl.DotNetVersion == Common.DotNetVersion.NetCore31)
            {
                ...
                string dir = Common.EasyPeasyDataDirectory + "Grawl" + Path.DirectorySeparatorChar + sanitizedName + Path.DirectorySeparatorChar;
                string ResultName;
            ...
            {
                throw new EasyPeasyCompileGrawlStagerFailedException("Compiling Grawl code failed");
            }
            if (Compress)
            {
            ...
            switch (profile.Type)
            {
                case ProfileType.HTTP:
                    ...
                    if (template.CommType == CommunicationType.HTTP)
                    {
                        return CodeTemplate
                            ...
                            .Replace("{{REP_PROF_HTTP_HEADER_NAMES}}", this.FormatForVerbatimString(string.Join(",", httpProfile.HttpRequestHeaders.Select(H => Convert.ToBase64String(Common.EasyPeasyEncoding.GetBytes(H.Name))))))
                            .Replace("{{REP_PROF_HTTP_HEADER_VALUES}}", this.FormatForVerbatimString(string.Join(",", httpProfile.HttpRequestHeaders.Select(H => Convert.ToBase64String(Common.EasyPeasyEncoding.GetBytes(H.Value))))))
                            .Replace("{{REP_PROF_HTTP_URLS}}", this.FormatForVerbatimString(string.Join(",", httpProfile.HttpUrls.Select(H => Convert.ToBase64String(Common.EasyPeasyEncoding.GetBytes(H))))))
                            ...
                            .Replace("{{REP_EASYPEASY_URIS}}", this.FormatForVerbatimString(string.Join(",", httpListener.Urls)))
                            .Replace("{{REP_EASYPEASY_CERT_HASH}}", this.FormatForVerbatimString(httpListener.UseSSL ? httpListener.SSLCertHash : ""))
                ...
                case ProfileType.Bridge:
                    ...
                    return CodeTemplate
                        ...
                        .Replace("{{REP_PIPE_NAME}}", grawl.SMBPipeName)
                        .Replace("{{REP_EASYPEASY_URI}}", this.FormatForVerbatimString(bridgeListener.ConnectAddresses[0] + ":" + bridgeListener.ConnectPort))
                        .Replace("{{REP_GRAWL_ANOTHERID}}", this.FormatForVerbatimString(grawl.OriginalServerGuid))
                        .Replace("{{REP_DELAY}}", this.FormatForVerbatimString(grawl.Delay.ToString()))
                        .Replace("{{REP_JITTER_PERCENT}}", this.FormatForVerbatimString(grawl.JItterPercent.ToString()))
                        .Replace("{{REP_CONNECT_ATTEMPTS}}", this.FormatForVerbatimString(grawl.ConneCTAttEmpts.ToString()))
        ...
        public async Task<GrawlTasking> CreateGrawlTasking(GrawlTasking tasking)
        {
            ...
            {
                parameters[0] = Common.EasyPeasyEncoding.GetString(Convert.FromBase64String(tasking.Grawl.PowerShellImport)) + "\r\n" + parameters[0];
            }
...
{{
    ...
    {{
        ...
        public async Task<Profile> CreateProfile(Profile profile, EasyPeasyUser currentUser)
        {
        ...
        public async Task<Profile> EditProfile(Profile profile, EasyPeasyUser currentUser)
        {
        ...
        public async Task<HttpProfile> CreateHttpProfile(HttpProfile profile, EasyPeasyUser currentUser)
        {
            if (!await this.IsAdmin(currentUser))
            {
                throw new ControllerUnauthorizedException($"Unauthorized - User with username: {currentUser.UserName} is not an Administrator and cannot create new profiles");
        ...
        public async Task<BridgeProfile> CreateBridgeProfile(BridgeProfile profile, EasyPeasyUser currentUser)
        {
            if (!await this.IsAdmin(currentUser))
            {
                throw new ControllerUnauthorizedException($"Unauthorized - User with username: {currentUser.UserName} is not an Administrator and cannot create new profiles");
        ...
        public async Task<HttpProfile> EditHttpProfile(HttpProfile profile, EasyPeasyUser currentUser)
        {
        ...
        public async Task<BridgeProfile> EditBridgeProfile(BridgeProfile profile, EasyPeasyUser currentUser)
        {
        ...
        public async Task<Listener> EditListener(Listener listener)
        {
            ...
            matchingListener.EasyPeasyUrl = listener.EasyPeasyUrl;
            matchingListener.EasyPeasyToken = listener.EasyPeasyToken;
        ...
        public async Task<HttpListener> CreateHttpListener(HttpListener listener)
        {
            ...
            EasyPeasyUser listenerUser = await this.CreateUser(new EasyPeasyUserLogin
            {
            ...
            listener.EasyPeasyUrl = "https://localhost:" + _configuration["EasyPeasyPort"];
            listener.EasyPeasyToken = Utilities.GenerateJwtToken(
