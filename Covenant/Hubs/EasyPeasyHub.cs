...
{
    public class EasyPeasyHub : Hub
    {
        private readonly IEasyPeasyService _service;

        public EasyPeasyHub(IEasyPeasyService service)
        {
            _service = service;
        }
        /*
        ...
        */
        ...
        public Task<EasyPeasyUser> EditUser(EasyPeasyUser currentUser, EasyPeasyUserLogin user)
        {
