...
{
    public class EasyPeasyContext : IdentityDbContext<EasyPeasyUser>
    {
        ...
        public EasyPeasyContext(DbContextOptions<EasyPeasyContext> options) : base(options)
        {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
            => optionsBuilder
                .UseSqlite("Data Source=" + Common.EasyPeasyDatabaseFile);
