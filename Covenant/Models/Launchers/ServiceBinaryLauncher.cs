...
namespace EasyPeasy.Models.Launchers
{
    public class ServiceBinaryLauncher : DiskLauncher
    {
        ...
        public override string GetLauncher(string StagerCode, byte[] StagerAssembly, Grawl grawl, ImplantTemplate template)
        {
            ...
            {
                File = grawl.DotNetVersion == Common.DotNetVersion.Net35 ? Common.EasyPeasyAssemblyReferenceNet35Directory + "System.ServiceProcess.dll" : Common.EasyPeasyAssemblyReferenceNet40Directory + "System.ServiceProcess.dll",
